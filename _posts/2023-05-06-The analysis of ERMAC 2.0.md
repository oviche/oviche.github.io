...
- For the purpose that the malware performing its functionalities, the following permissions are needed to be granted.
  ...
  ## Display pop-up windows while running in the background permission
    ...
    -  The following code open-up a window for requesting this permission regarding the virus application. Additionally, it sets **autoClickPerm** to **"1"**, to signal the accessibility service to do auto-clicking to grant this permission.
